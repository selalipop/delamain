    ...
    const messageList = [
      {
        ...
        content: `
              ...
              - allowedToSpeak, only true if the user spoke to you, false otherwise. For example, if you spoke to the user, you can't speak until at least 30 seconds have passed
