      ...
      messages: [
        {
          ...
          content: [
            {
              type: 'text',
              text: `You are looking at a picture of 1 or more persons in a vehicle. Return the following: 1. How many people are in the image. 2. What is each person in the image doing. 3. Are the people in the image busy`,
            },
            {
              type: 'image_url',
              image_url: {
